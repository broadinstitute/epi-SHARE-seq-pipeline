...
task atac_align_chromap {
    ...
    output {
        ...
        String atac_reads_count = read_string("reads_count.txt")
        String atac_mapped_reads = read_string("mapped_reads.txt")
        String atac_unique_reads = read_string("unique_reads.txt")
        String atac_multi_mapping_reads = read_string("multi_mapping_reads.txt")
        String atac_corrected_barcodes = read_string("corrected_barcodes.txt")
        String atac_unique_mappings_fragments = read_string("uni_mappings_fragments.txt")
        String atac_multi_mappings_fragments = read_string("multi_mappings_fragments.txt")
        Int atac_final_number_of_fragments = read_int("final_number_of_fragments.txt")
        String atac_unique_barcodes_unfiltered = read_string("unique_barcodes_unfiltered.txt")
