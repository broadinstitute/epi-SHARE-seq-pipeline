...
task qc_atac {
    ...
    command<<<
        ...
        time Rscript $(which atac_qc_plots.R) tmp-barcode-stats ~{fragment_min_cutoff} ~{hist_min_fragment} ~{hist_max_fragment} ~{fragment_barcode_rank_plot} ~{fragment_histogram}
    >>>
