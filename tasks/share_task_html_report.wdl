...
task html_report {
    ...
    #Array[Float?] nums_to_save = [atac_total_reads, atac_aligned_uniquely, atac_unaligned, atac_feature_reads, atac_duplicate_reads, atac_nrf, atac_pbc1, atac_pbc2, atac_percent_duplicates, rna_total_reads, rna_aligned_uniquely, rna_aligned_multimap, rna_unaligned, rna_feature_reads, rna_duplicate_reads]
    ...
    command <<<
        ...
        python3 /src/python/write_csv.py ~{other_output_file} names_list.txt numeric_list.txt image_list.txt log_list.txt
    >>>
