...
workflow share {
    ...
    if ( pipeline_modality != "no_align" ) {
        call html_report.html_report as html_report {
            input:
                ...
                # RNA plots
                ## TODO: edit this so that there are three files: one for top level, one for rna, and one for atac, something like 
                ## top_level_image_files = [...]
                ## atac_image_files = [...]
                ## rna_image_files = [...]
    ...
    output{
        ...
        Array[File] csv_images = summary_csv_png_data
