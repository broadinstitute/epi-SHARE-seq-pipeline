...
workflow share {
    ...
    output{
        ...
        File? html_summary = html_report.html_report_file
                        ...
                        ##names and data for the csv output file 
    
        Array[String] names_csv = ['prefix',
            'atac_total_reads',
            'atac_aligned_uniquely',
            'atac_unaligned',
            'atac_feature_reads',
            'atac_duplicate_reads',
            'atac_nrf',
            'atac_pbc1',
            'atac_pbc2',
            'atac_percent_duplicates',
            'rna_total_reads',
            'rna_aligned_uniquely',
            'rna_aligned_multimap',
            'rna_unaligned',
            'rna_feature_reads',
            'rna_duplicate_reads',
            'joint_qc_plot', 
            'joint_density_plot', 
            'share_rna_umi_barcode_rank_plot', 
            'share_rna_gene_barcode_rank_plot', 
            'share_rna_gene_umi_scatter_plot',
            'share_rna_seurat_raw_violin_plot', 
            'share_rna_seurat_raw_qc_scatter_plot', 
            'share_rna_seurat_filtered_violin_plot', 
            'share_rna_seurat_filtered_qc_scatter_plot', 
            'share_rna_seurat_variable_genes_plot', 
            'share_rna_seurat_PCA_dim_loadings_plot', 
            'share_rna_seurat_PCA_plot', 
            'share_rna_seurat_heatmap_plot', 
            'share_rna_seurat_jackstraw_plot', 
            'share_rna_seurat_elbow_plot', 
            'share_rna_seurat_umap_cluster_plot', 
            'share_rna_seurat_umap_rna_count_plot', 
            'share_rna_seurat_umap_gene_count_plot', 
            'share_rna_seurat_umap_mito_plot', 
            'share_atac_qc_barcode_rank_plot', 
            'share_atac_qc_hist_plot', 
            'share_atac_qc_tss_enrichment', 
            'share_atac_archr_gene_heatmap_plot', 
            'share_atac_archr_raw_tss_enrichment', 
            'share_atac_archr_filtered_tss_enrichment', 
            'share_atac_archr_raw_fragment_size_plot', 
            'share_atac_archr_filtered_fragment_size_plot', 
            'share_atac_archr_umap_doublets', 
            'share_atac_archr_umap_cluster_plot', 
            'share_atac_archr_umap_doublets', 
            'share_atac_archr_umap_num_frags_plot', 
            'share_atac_archr_umap_tss_score_plot', 
            'share_atac_archr_umap_frip_plot',
            'share_atac_archr_gene_heatmap_plot', 
            'share_atac_archr_strict_raw_tss_enrichment', 
            'share_atac_archr_strict_filtered_tss_enrichment', 
            'share_atac_archr_strict_raw_fragment_size_plot', 
            'share_atac_archr_strict_filtered_fragment_size_plot', 
            'share_atac_archr_strict_umap_doublets', 
            'share_atac_archr_strict_umap_cluster_plot', 
            'share_atac_archr_umap_doublets', 
            'share_atac_archr_strict_umap_num_frags_plot', 
            'share_atac_archr_strict_umap_tss_score_plot', 
            'share_atac_archr_strict_umap_frip_plot',
            'share_atac_archr_strict_gene_heatmap_plot', 
            'j_plot',
            'share_rna_alignment_log',  
            'share_task_starsolo_barcodes_stats', 
            'share_task_starsolo_features_stats', 
            'share_task_starsolo_summary_csv', 
            'share_task_starsolo_umi_per_cell', 
            'share_task_starsolo_raw_tar',
            'share_rna_seurat_notebook_log', 
            'share_atac_alignment_log', 
            'share_atac_archr_notebook_log', 
            'dorcs_notebook_log']
    
        Array[Int] nums_csv = [prefix,
            atac.share_atac_total_reads,
            atac.share_atac_aligned_uniquely,
            atac.share_atac_unaligned,
            atac.share_atac_feature_reads,
            atac.share_atac_duplicate_reads,
            atac.share_atac_nrf,
            atac.share_atac_pbc1,
            atac.share_atac_pbc2,
            atac.share_atac_percent_duplicates,
            rna.share_rna_total_reads,
            rna.share_rna_aligned_uniquely,
            rna.share_rna_aligned_multimap,
            rna.share_rna_unaligned,
            rna.share_rna_feature_reads,
            rna.share_rna_duplicate_reads]
    
        Array[String] images_csv = [joint_qc.joint_qc_plot, 
            joint_qc.joint_density_plot, 
            rna.share_rna_umi_barcode_rank_plot, 
            rna.share_rna_gene_barcode_rank_plot, 
            rna.share_rna_gene_umi_scatter_plot, 
            rna.share_rna_seurat_raw_violin_plot,
            rna.share_rna_seurat_raw_qc_scatter_plot, 
            rna.share_rna_seurat_filtered_violin_plot, 
            rna.share_rna_seurat_filtered_qc_scatter_plot, 
            rna.share_rna_seurat_variable_genes_plot, 
            rna.share_rna_seurat_PCA_dim_loadings_plot, 
            rna.share_rna_seurat_PCA_plot, 
            rna.share_rna_seurat_heatmap_plot, 
            rna.share_rna_seurat_jackstraw_plot, 
            rna.share_rna_seurat_elbow_plot, 
            rna.share_rna_seurat_umap_cluster_plot, 
            rna.share_rna_seurat_umap_rna_count_plot, 
            rna.share_rna_seurat_umap_gene_count_plot, 
            rna.share_rna_seurat_umap_mito_plot, 
            atac.share_atac_qc_barcode_rank_plot, 
            atac.share_atac_qc_hist_plot, 
            atac.share_atac_qc_tss_enrichment, 
            atac.share_atac_archr_gene_heatmap_plot, 
            atac.share_atac_archr_raw_tss_enrichment, 
            atac.share_atac_archr_filtered_tss_enrichment, 
            atac.share_atac_archr_raw_fragment_size_plot, 
            atac.share_atac_archr_filtered_fragment_size_plot, 
            atac.share_atac_archr_umap_doublets, 
            atac.share_atac_archr_umap_cluster_plot, 
            atac.share_atac_archr_umap_doublets, 
            atac.share_atac_archr_umap_num_frags_plot, 
            atac.share_atac_archr_umap_tss_score_plot, 
            atac.share_atac_archr_umap_frip_plot,
            atac.share_atac_archr_gene_heatmap_plot, 
            atac.share_atac_archr_strict_raw_tss_enrichment, 
            atac.share_atac_archr_strict_filtered_tss_enrichment, 
            atac.share_atac_archr_strict_raw_fragment_size_plot, 
            atac.share_atac_archr_strict_filtered_fragment_size_plot, 
            atac.share_atac_archr_strict_umap_doublets, 
            atac.share_atac_archr_strict_umap_cluster_plot, 
            atac.share_atac_archr_umap_doublets, 
            atac.share_atac_archr_strict_umap_num_frags_plot, 
            atac.share_atac_archr_strict_umap_tss_score_plot, 
            atac.share_atac_archr_strict_umap_frip_plot,
            atac.share_atac_archr_strict_gene_heatmap_plot,
            dorcs.j_plot]

        Array[String] log_files_csv = [rna.share_rna_alignment_log,  
            rna.share_task_starsolo_barcodes_stats, 
            rna.share_task_starsolo_features_stats, 
            rna.share_task_starsolo_summary_csv, 
            rna.share_task_starsolo_umi_per_cell, 
            rna.share_task_starsolo_raw_tar,
            rna.share_rna_seurat_notebook_log, 
