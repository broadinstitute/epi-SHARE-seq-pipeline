    ...
    if ( pipeline_modality != "no_align" ) {
        call html_report.html_report as html_report {
            input:
                ...
                # RNA plots
                # joint_qc plot made in joint_cell_plotting.py
                # joint_qc desnity plot made in joint cell plotting density.R
                # share rna umi barcode rank made in rna_qc_plots.R
                # share rna gene barcode rank plot made in rna_qc_plots.R
                # share rna gene umi scatter plot made in rna_qc_plots.R
                # share tna seurat raw violin plot made in seurat_notebook.ipynb 
                # share rna seurat raw qc scatter plot in seurat_notebook.ipynb
                # share rna seurat filtered violin plot in seurat_notebook.ipynb 
                # share rna seurat filtered qc scatter plot in seurat_notebook.ipynb
                # share rna seurat variable genes plot in seurat_notebook.ipynb
                # share rna seurat PCA dim loadings seurat_notebook.ipynb
                # share rna pca plot made in seurat_notebook.ipynb
                # share rna seurat heatmap plot in seurat_notebook.ipynb
                # all share rna seurat stuff made in the seurat notebook
                # atac share qc barcode rank plot made in atac_qc_plots.R
                # atac share atac qc hist plot made in share_task_qc_atac
                ...
                #image_files = [atac.share_atac_qc_hist_plot, atac.share_atac_qc_tss_enrichment, atac.share_atac_archr_gene_heatmap_plot, atac.share_atac_archr_raw_tss_enrichment, atac.share_atac_archr_filtered_tss_enrichment, atac.share_atac_archr_raw_fragment_size_plot, atac.share_atac_archr_filtered_fragment_size_plot, atac.share_atac_archr_umap_doublets, atac.share_atac_archr_umap_cluster_plot, atac.share_atac_archr_umap_doublets, atac.share_atac_archr_umap_num_frags_plot, atac.share_atac_archr_umap_tss_score_plot, atac.share_atac_archr_umap_frip_plot,atac.share_atac_archr_gene_heatmap_plot, atac.share_atac_archr_strict_raw_tss_enrichment, atac.share_atac_archr_strict_filtered_tss_enrichment, atac.share_atac_archr_strict_raw_fragment_size_plot, atac.share_atac_archr_strict_filtered_fragment_size_plot, atac.share_atac_archr_strict_umap_doublets, atac.share_atac_archr_strict_umap_cluster_plot, atac.share_atac_archr_umap_doublets, atac.share_atac_archr_strict_umap_num_frags_plot, atac.share_atac_archr_strict_umap_tss_score_plot, atac.share_atac_archr_strict_umap_frip_plot,atac.share_atac_archr_strict_gene_heatmap_plot, dorcs.j_plot],
                image_file_paths = [(string) joint_qc.joint_qc_plot, (string) joint_qc.joint_density_plot, (string) rna.share_rna_umi_barcode_rank_plot, (string) rna.share_rna_gene_barcode_rank_plot, (string) rna.share_rna_gene_umi_scatter_plot, (string) rna.share_rna_seurat_raw_violin_plot, (string) rna.share_rna_seurat_raw_qc_scatter_plot, (string) rna.share_rna_seurat_filtered_violin_plot, (string) rna.share_rna_seurat_filtered_qc_scatter_plot, (string) rna.share_rna_seurat_variable_genes_plot, (string) rna.share_rna_seurat_PCA_dim_loadings_plot, (string) rna.share_rna_seurat_PCA_plot, (string) rna.share_rna_seurat_heatmap_plot, (string) rna.share_rna_seurat_jackstraw_plot, (string) rna.share_rna_seurat_elbow_plot, (string) rna.share_rna_seurat_umap_cluster_plot, (string) rna.share_rna_seurat_umap_rna_count_plot, (string) rna.share_rna_seurat_umap_gene_count_plot, (string) rna.share_rna_seurat_umap_mito_plot, (string) atac.share_atac_qc_barcode_rank_plot, (string) atac.share_atac_qc_hist_plot, (string) atac.share_atac_qc_tss_enrichment, (string) atac.share_atac_archr_gene_heatmap_plot, (string) atac.share_atac_archr_raw_tss_enrichment, (string) atac.share_atac_archr_filtered_tss_enrichment, (string) atac.share_atac_archr_raw_fragment_size_plot, (string) atac.share_atac_archr_filtered_fragment_size_plot, (string) atac.share_atac_archr_umap_doublets, (string) atac.share_atac_archr_umap_cluster_plot, (string) atac.share_atac_archr_umap_doublets, (string) atac.share_atac_archr_umap_num_frags_plot, (string) atac.share_atac_archr_umap_tss_score_plot, (string) atac.share_atac_archr_umap_frip_plot, (string) atac.share_atac_archr_gene_heatmap_plot, (string) atac.share_atac_archr_strict_raw_tss_enrichment, (string) atac.share_atac_archr_strict_filtered_tss_enrichment, (string) atac.share_atac_archr_strict_raw_fragment_size_plot, (string) atac.share_atac_archr_strict_filtered_fragment_size_plot, (string) atac.share_atac_archr_strict_umap_doublets, (string) atac.share_atac_archr_strict_umap_cluster_plot, (string) atac.share_atac_archr_umap_doublets, (string) atac.share_atac_archr_strict_umap_num_frags_plot, (string) atac.share_atac_archr_strict_umap_tss_score_plot, (string) atac.share_atac_archr_strict_umap_frip_plot, (string) atac.share_atac_archr_strict_gene_heatmap_plot, (string) dorcs.j_plot]
