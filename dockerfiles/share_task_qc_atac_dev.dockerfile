...
RUN python3 -m pip install --no-cache-dir --ignore-installed numpy matplotlib pysam --editable=git+https://github.com/kundajelab/SAMstats@75e60f1e67c6d5d066371a0b53729e4b1f6f76c5#egg=SAMstats
